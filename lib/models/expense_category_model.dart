...
class ExpenseCategory {
  ...
  // we need a method to convert this 'model' to a 'Map' so that we can insert it into a database
  ...
  // when we retrieve the data from the database it will be a 'Map', need to convert it back to a 'Expense Category'
  factory ExpenseCategory.fromString(Map<String, dynamic> value) =>
      ExpenseCategory(
        ...
        icon: expense_categories[value['title']]!,
      );
}